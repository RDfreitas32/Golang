...
//estrutura para criar as requisições via Serviço postman
...
// BuscarUsuarios Get para usuarios
...
// buscarUsuarios Get para usuario
...
// DeletarUsuario remove um usuario do banco
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	db, erro := banco.Conectar()
	if erro != nil {
		w.Write([]byte("Erro ao conecatar com banco de dados!"))
		return
	}
	defer db.Close()
